...
public class CargarContenidoCardView extends Fragment{
    ...
    public static CargarContenidoCardView nuevaInstancia(int itemMenu,int compMenu ) {
        CargarContenidoCardView fragment = new CargarContenidoCardView();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState ) {
        ...
        if (savedInstanceState == null) {
            ...
            poblarViewPager(viewPager, itemMenu);
