...
import com.dhenao.miestadio.system.autenticacion.AuthenticatorActivity;


public class MiestadioAuthenticator  extends AbstractAccountAuthenticator {

    private String TAG = "MiestadioAuthenticator";
    private final Context mContext;

    public MiestadioAuthenticator(Context context) {
        super(context);
